# QBIT NOVA Native — Stage 5.2 Trust/Replay/Revocation

> Experimental checkpoint branch; not a production release.

## Branch checkpoint

- Branch: `stage5.2-trust-replay-revocation`
- Inspected code tip: `eaa2bdc3941e`
- Focus: Adds trusted-issuer, replay-ledger, revocation-store and deterministic receipt evidence beyond the inherited Stage 5 text.
