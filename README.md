# QBIT NOVA Native — V10 Data Step 2B

> Experimental checkpoint branch; not a production release.

## Branch checkpoint

- Branch: `dev/v10-native-data-step2b-qbc10-layout`
- Inspected code tip: `21dced5ef75e`
- Focus: Locks the typed QBC v10 data layout and tests canonical encoding boundaries; it does not add V10 QVM execution.
