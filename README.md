# QBIT NOVA Native — Stage 7 Step 4

> Experimental checkpoint branch; not a production release.

## Branch checkpoint

- Branch: `stage7-step4-if-else-control-flow`
- Inspected code tip: `6c8a7f542278`
- Focus: Adds deterministic native if/else control flow.
