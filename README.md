# QBIT NOVA Native — Universal Dragon OS Bootstrap

> Experimental checkpoint branch; not a production release.

## Branch checkpoint

- Branch: `claude/huawei-pura-70-bootloader-hv0xvz`
- Inspected code tip: `a3ccf3ef035e`
- Focus: Buildroot external tree, QEMU AArch64 scripts and qnova package integration. This is not a Huawei bootloader unlock or exploit.
