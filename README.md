# QBIT NOVA Native — Stage 7 Step 2

> Experimental checkpoint branch; not a production release.

## Branch checkpoint

- Branch: `stage7-step2-u32-arithmetic`
- Inspected code tip: `d3b0f1d71f3b`
- Focus: Adds checked u32 subtraction, multiplication and division.
