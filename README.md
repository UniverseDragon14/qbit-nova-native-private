# QBIT NOVA Native — Stage 7 Typed Core

> Experimental checkpoint branch; not a production release.

## Branch checkpoint

- Branch: `stage7-native-language-core`
- Inspected code tip: `d64acd4e5641`
- Focus: Adds typed u32 scalar language/runtime support on top of the QBC/QVM foundation.
