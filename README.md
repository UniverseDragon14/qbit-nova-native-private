# QBIT NOVA Native — Dragon Voice Smile PoC

> Experimental checkpoint branch; not a production release.

## Branch checkpoint

- Branch: `dragon-voice-v3-smile-poc`
- Inspected code tip: `0b457ac92e39`
- Focus: Encodes a small emotion/smile state into one u32 QN emit packet; it is not a speech or audio runtime.
