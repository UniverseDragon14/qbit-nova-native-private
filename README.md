# QBIT NOVA Native — Stage 7 Step 8

> Experimental checkpoint branch; not a production release.

## Branch checkpoint

- Branch: `stage7-step8-function-control-flow`
- Inspected code tip: `6749fa8187df`
- Focus: Adds deterministic control flow inside native functions.
